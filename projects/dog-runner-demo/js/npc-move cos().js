...
window.addEventListener('load', function() {
    ...
    class Enemy {
        ...
        update() {
            this.x = this.canvas.width/2 * Math.cos(this.angle * Math.PI/90) + (this.canvas.width/2 - this.width/2);
    ...
    for (let i = 0; i < canvas1.amountOfEnemies; i++) {
        const enemy = new Enemy('../sprites/enemy3.png', canvas1, 6, 1, 2.5, 2.5);
